  ...
  template: `
    <div class="min-h-screen bg-slate-50">
      <div class="max-w-4xl mx-auto">
        ...
        <div *ngIf="cartService.cartItems().length === 0" class="bg-white">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 mx-auto text-slate-300">
        ...
        <div *ngIf="cartService.cartItems().length > 0" class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="md:col-span-2 space-y-4">
            <div *ngFor="let item of cartService.cartItems()" class="flex items-center space-x-4 bg-white">
              ...
              <div class="flex-grow">
                ...
                <div class="flex items-center space-x-4">
                  <div class="flex items-center border border-slate-200">
                    <button (click)="cartService.updateQuantity(item.id, item.quantity - 1)" class="w-8 flex justify-center text-slate-500 hover:bg-slate-100">-</button>
          ...
          <div class="bg-white">
            ...
            <div class="space-y-3 mb-6 text-slate-600">
              <div class="flex justify-between">
                ...
                <span class="text-slate-900">\${{ cartService.cartTotal() | number:'1.2-2' }}</span>
              </div>
              <div class="flex justify-between">
                <span>Taxes</span>
